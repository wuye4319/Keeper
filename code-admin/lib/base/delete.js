...
Delete.prototype.deleteSource = function (dir, type) {
...
Delete.prototype.deletefile = function (dir) {
    fs.unlinkSync(dir);
    console.log(dir.yellow + " is delete successed!".green);
}

//foreach the path to delete file
Delete.prototype.deleteDir = function (dir) {
...
Delete.prototype.deleteAll = function (myfilepath) {
    var that = this;
