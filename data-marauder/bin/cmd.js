...
let cmdlist = [{
  name: 'clear',
  desc: 'Clear all cache, confirm your opration carefully',
  action: function () {
  ...
  name: 'rob',
  desc: 'a robot to do sth for you',
  action: function () {
    // robot.robot()
  }
}, {
  ...
  name: 'manualchangeip',
  desc: 'Close active change ip, and manual change ip by index',
  action: async function () {
    await proxy.manualchangeip()
  }
}, {
  name: 'autoproxy',
  desc: 'Auto active change ip',
  alias: 'crt',
  action: async function () {
