...
static.prototype.jsStr = function (file, data) {
...
static.prototype.hascont = function (str, content) {
    var strn = str + "\n";
    var strr = str + "\r";
    var strnr = str + "\r\n";
...
static.prototype.contstr = function (file, data) {
    var content = fs.readFileSync(file).toString();
    var firstStr = "<body>";
...
static.prototype.static = function (Prompt, param) {
    var self = this;
    //init html
    var mydatafile = [];
