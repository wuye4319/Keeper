...
class InitJs {
  ...
  getimg (browser, type) {
    return new Promise(async (resolve) => {
      ...
      try {
        await page.goto(
          'https://login.taobao.com/member/login.jhtml?style=mini&newMini2=true&css_style=alimama&from=alimama&redirectURL=http%3A%2F%2Fpub.alimama.com/promo/search/index.htm&full_redirect=true&disableQuickLogin=true'
        )
        ...
        page.on('load', async () => {
          ...
          let mypageinfor = await page.evaluate(() => {
            return {
              ...
              loginacc: document.getElementsByClassName('menu-username')[0].innerHTML || ''
            }
          })
